...
ls_result_t ls_capture_cpu_context(const ls_arch_context_t *context){
    ...
    ls_event_t event={LS_EVENT_CRASH,LS_PRIORITY_CRITICAL,ls_uptime_ms(),fingerprint,"cpu",(int32_t)context->fault,LS_SEVERITY_FATAL,"exception",context,0,0,0,LS_ENABLE_STACK_SNAPSHOT?LS_CAPTURE_STACK:LS_CAPTURE_SNAPSHOT};
