...
ls_result_t ls_envelope_visit_secure_replay(const uint8_t *data,size_t length,ls_envelope_replay_t *replay,uint8_t *workspace,size_t workspace_size,ls_tlv_visitor_t visitor,void *context);
#endif
