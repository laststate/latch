...
typedef ls_result_t (*ls_transport_send_fragment_v2_fn)(
    void *context, const ls_transport_fragment_t *fragment);
typedef bool (*ls_transport_retry_fn)(void *context, uint8_t attempt,
                                      ls_result_t result);
