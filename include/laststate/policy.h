...
#include <stdint.h>
#include "event.h"
typedef enum {LS_PER_SECOND=1000u,LS_PER_MINUTE=60000u,LS_PER_HOUR=3600000u} ls_rate_period_t;
typedef struct {uint32_t fingerprint,count,first_seen_ms,last_seen_ms;} ls_dedup_snapshot_t;
