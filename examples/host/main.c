...
static bool uart_available(void *unused) {
    (void)unused;
    return true;
}
static ls_result_t uart_send(void *unused, const uint8_t *bytes, size_t count) {
    (void)unused;
