...
*** Variables ***
${SCRIPT}         C:/Users/USER/LastState/latch/hil/emulator/evidence/sam4s/sam4s.resc
${ELF}            C:/Users/USER/LastState/latch/build/emulator/latch-renode-sam4s.elf
${MARKER}         0x20001000
...
*** Test Cases ***
sam4s USAGEFAULT Reaches Production Handler
