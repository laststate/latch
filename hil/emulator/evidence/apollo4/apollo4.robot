...
*** Variables ***
${SCRIPT}         C:/Users/USER/LastState/latch/hil/emulator/evidence/apollo4/apollo4.resc
${ELF}            C:/Users/USER/LastState/latch/build/emulator/latch-renode-apollo4.elf
${MARKER}         0x10061000
...
Wait For Marker
    ...
    ${status_raw}=  Read Word  0x10061004
    ${status}=  Convert To Integer  ${status_raw}
    Should Be Equal As Integers  ${status}  0

*** Test Cases ***
apollo4 USAGEFAULT Reaches Production Handler
