...
typedef struct {void *context;void (*start_watchdog)(void *context,uint32_t timeout_ms);void (*emit)(void *context,const char *line);} ls_hil_platform_t;
...
ls_result_t ls_hil_test_flash(ls_storage_backend_t *flash,size_t offset,size_t erase_length,uint32_t pattern);
#endif
